...
FEATURE_COLUMNS = ["volatility_bbm","volatility_bbl","volatility_bbh","volatility_kch","volatility_kcl","volatility_kcw","ichibaseline","ichiconversionline","adjclose"]

INDICATOR_TO_TRAIN="ichiconversionline"
